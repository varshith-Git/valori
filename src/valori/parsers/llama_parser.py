...
class LlamaParser(DocumentParser):
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            raise ParsingError(
                "llama-parse not installed. Install with: pip install llama-parse"
            )
    ...
    def parse(self, file_path: Union[str, Path]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ParsingError(
                f"Failed to parse document with LlamaParse {file_path}: {str(e)}"
            )

    def _create_chunks(
        self, text: str, documents_metadata: List[Dict]
    ) -> List[Dict[str, Any]]:
    ...
    def _get_document_info(
        self, position: int, documents_metadata: List[Dict]
    ) -> Dict[str, Any]:

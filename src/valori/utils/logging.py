...
def log_vector_operation(
    operation: str, vector_count: int, vector_dim: int, **kwargs
) -> None:
    """
...
def log_index_stats(index_type: str, vector_count: int, **stats) -> None:
    ...
    metrics = {"index_type": index_type, "vector_count": vector_count, **stats}

    logger.info(f"Index stats: {metrics}")


def log_search_query(
    query_vector_dim: int, k: int, results_count: int, duration: float
) -> None:
    """

...
class VectorAnalyzer:
    ...
    def _similarity_analysis(
        ...
        # Normalize vectors
        normalized = sample_vectors / np.linalg.norm(
...
class IndexInspector:
    ...
    def _inspect_hash_tables(self) -> Dict[str, Any]:
        ...
        total_entries = sum(
            sum(len(bucket) for bucket in table.values()) for table in hash_tables
        )

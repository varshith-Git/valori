...
def create_document_db(
    ...
    **kwargs,
    ...
    db_config = {"index_type": index_type, "storage_type": "memory", **kwargs}
...
TEMPLATES = {
    "small_dataset": {"index_type": "flat", "storage_type": "memory"},
    "medium_dataset": {
        "index_type": "annoy",
        "storage_type": "memory",
        "index_config": {"metric": "angular", "num_trees": 10, "search_k": -1},
    },
    "large_dataset": {
        "index_type": "ivf",
        "storage_type": "disk",
        "index_config": {"metric": "cosine", "n_clusters": 1000, "n_probes": 10},
    },
    "high_dimensional": {
        "index_type": "lsh",
        "storage_type": "memory",
    ...
    "real_time_search": {
        "index_type": "annoy",
        "storage_type": "memory",
        "index_config": {"metric": "angular", "num_trees": 5, "search_k": 10},
    },
    "document_search": {
        "index_type": "hnsw",
        "storage_type": "memory",

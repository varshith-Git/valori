...
class ProcessingPipeline:
    ...
    def process_document(
        self, file_path: Union[str, Path], parser_name: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_pipeline_info(self) -> Dict[str, Any]:
        ...
        for processor in self.processors:
            processor_info.append(
                {"name": processor.__class__.__name__, "stats": processor.get_stats()}
            )
        ...
        return {
            ...
            "parser_info": (
                self.parser_registry.get_parser_info() if self.parser_registry else {}
            ),
            "supported_formats": self.get_supported_formats(),
        }

    def _get_parser_name(
        self, file_path: Union[str, Path], parser_name: Optional[str] = None
    ) -> str:

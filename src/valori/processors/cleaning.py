...
class CleaningProcessor(DocumentProcessor):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.special_chars_pattern = config.get(
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        if self._total_characters_before > 0:
            compression_ratio = (
                self._total_characters_after / self._total_characters_before
            )
        ...
        return {
            ...
            "characters_removed": self._total_characters_before
            - self._total_characters_after,

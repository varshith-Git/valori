...
class TestMemoryStorage:
    ...
    def test_update_vector(self, memory_storage, sample_vectors):
        ...
        # Update vector
        success = memory_storage.update_vector(
            vector_id, updated_vector, updated_metadata
        )
        assert success
...
class TestHybridStorage:
    ...
    def test_memory_limit_eviction(self, hybrid_storage, sample_vectors):
        ...
        for i in range(60):  # More than memory_limit of 50
            vector_id = f"test_vector_{i}"
            hybrid_storage.store_vector(
                vector_id, sample_vectors[i % len(sample_vectors)]
            )
...
class TestStorageErrorHandling:
    ...
    def test_uninitialized_storage_error(
        self, uninitialized_memory_storage, sample_vectors
    ):

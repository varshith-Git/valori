...
class TestVectorDBClientIntegration:
    ...
    def test_memory_flat_integration(
        self, sample_vectors, sample_metadata, query_vector
    ):
    ...
    def test_disk_hnsw_integration(
        self, temp_dir, sample_vectors, sample_metadata, query_vector
    ):
    ...
    def test_hybrid_ivf_integration(
        self, temp_dir, sample_vectors, sample_metadata, query_vector
    ):
    ...
    def test_full_integration(
        ...
        persistence = TensorPersistence(
            {"data_dir": str(temp_dir / "full_persistence")}
        )
...
class TestEndToEndWorkflows:
    ...
    def test_build_and_search_workflow(
        self, sample_vectors, sample_metadata, query_vector
    ):
